...
#this while loop will continue to repeat the psr game
psr_choice = ''
while psr_choice != 'exit':
    program_choice = random.choice(psr)

    #ask user for choice (paper/scissors/rock)
    psr_choice=input("Paper,Scissors or Rock? or exit program (type paper/scissors/rock/exit): ")
